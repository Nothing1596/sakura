...
def test_high_precision_http_status_code_needs_error_context(
    classifier: RuleClassifier,
    text: str,
) -> None:
...
def test_high_precision_http_status_code_with_context_is_error(
    classifier: RuleClassifier,
    text: str,
) -> None:
...
def test_high_precision_only_closed_and_structural_signals(
    classifier: RuleClassifier,
) -> None:
